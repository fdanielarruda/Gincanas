                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    <tr v-for="gymkhana in props.gymkhanas" :key="gymkhana.id">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <IconButton :href="route('gymkhana.judges.index', gymkhana.id)" color="gray" title="Juízes">
                                <ShieldCheckIcon class="h-5 w-5" />
                            </IconButton>

                            <IconButton :href="route('gymkhana.teams.index', gymkhana.id)" class="ml-1" color="blue"
                                title="Equipes">
                            ...
                            <IconButton :href="route('gymkhana.edit', gymkhana.id)" class="ml-1" color="yellow"
                                title="Editar">
